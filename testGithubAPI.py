...
class TestGitHubAPI(unittest.TestCase):
    ...
    def testLoliveto(self):
        self.assertEqual(display("loliveto"),[('cuddly-fiesta', 1), ('D6Project', 8), ('GitHubApi567', 9, ('HW01triangles', 6), ('newD6', 30), ('SSW322-Project', 30), ('SSW567HelloWorld', 6), ('Triangle567', 10)])
